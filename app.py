...
tiempo_impresion = st.text_input("⏱️ Tiempo de impresión (hh:mm)", "01:00")  # si tu función lo espera como string
...
if st.button("Calcular precio"):
    coste_total, coste_unitario, coste_impresion, coste_mano_obra = precio_total(
        tipo_filamento,
        tiempo_impresion,
        cantidad_filamento,
        cambios_filamento,
